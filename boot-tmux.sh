...
tmux send-keys -t 'dirt-vim' 'cd ~/dirt' C-m 'clear' C-m 'vim -S ~/.vim/sessions/dirt' C-m ':let g:session_name="dirt"' C-m 
...
tmux send-keys -t 'dirt1-vim' 'cd ~/dirt1' C-m 'clear' C-m 'vim -S ~/.vim/sessions/dirt1' C-m ':let g:session_name="dirt1"' C-m
